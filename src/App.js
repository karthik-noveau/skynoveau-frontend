...
const C_page_10 = React.lazy(() =>
  import("./components/Course-pages/C_page_10")
);
const C_page_11 = React.lazy(() =>
  import("./components/Course-pages/C_page_11")
);
const C_page_12 = React.lazy(() =>
  import("./components/Course-pages/C_page_12")
);
const C_page_13 = React.lazy(() =>
  import("./components/Course-pages/C_page_13")
);
const C_page_14 = React.lazy(() =>
  import("./components/Course-pages/C_page_14")
);
const C_page_16 = React.lazy(() =>
  import("./components/Course-pages/C_page_16")
);
...
const I_page_10 = React.lazy(() =>
  import("./components/Intern-pages/I_page_10")
);
const I_page_12 = React.lazy(() =>
  import("./components/Intern-pages/I_page_12")
);
const I_page_13 = React.lazy(() =>
  import("./components/Intern-pages/I_page_13")
);
const I_page_14 = React.lazy(() =>
  import("./components/Intern-pages/I_page_14")
);
const I_page_15 = React.lazy(() =>
  import("./components/Intern-pages/I_page_15")
);
const I_page_16 = React.lazy(() =>
  import("./components/Intern-pages/I_page_16")
);
  ...
  return (
    <div>
      {loader ? (
        ...
        <div>
          <div>
            <a href="https://wa.link/y2gz6b" target="_blank">
              <img
                src={whatsapp_icon}
                style={{
                  width: "52px",
